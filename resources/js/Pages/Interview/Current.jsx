...
import { UserIcon, PlayIcon, StopIcon, LockOpenIcon } from '@heroicons/react/24/solid';
            ...
            <div className="m-5 bg-gray-100 flex items-center justify-center">
                <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="h-250 bg-white shadow-lg rounded-lg p-6">
                        <h1 className="text-3xl font-bold mb-6 bg-graydark p-3 rounded-md text-center text-white">Test: {interview.name}</h1>
                        ...
                        <div className="mb-6 text-center">
                            ...
                            <div className="flex justify-center">
                                    ...
                                    {/* <button
                                        onClick={stopTest}
                                        className={`px-6 py-3 rounded-full flex items-center justify-center space-x-2 transition duration-300 ${
                                            isExpired ? 'bg-red-500' : 'bg-yellow-500'
                                        } text-white hover:opacity-90`}
                                    >
                                        <StopIcon className="h-6 w-6" />
                                        <span>{isExpired ? 'Test Expired' : 'Stop Test'}</span>
                                    </button> */}
                                     <button
                                        onClick={stopTest}
                        ...
                        <div className="flex items-center">
                            <div className="relative">
                                <input
                                    ...
                                    className="py-2 px-4 pr-10 text-black rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-gray-50 text-sm"
                                />
