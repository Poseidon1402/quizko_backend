...
import ApplicationLogo from '../ApplicationLogoDash';
                    ...
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                         ( route().current("student_answers.index") || route().current("tests.index") || route().current("tests.current") || route().current("results.index")  ||  route().current("student_answers.studentTestAnswers"))  &&
                         'bg-graydark'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
